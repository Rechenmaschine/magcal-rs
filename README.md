...
> Magnetometer calibration in pure Rust, optimized for embedded use.
...
This is a Rust port of Freescale/NXP `magcal.c` by Paul Stoffregen.
...
The upstream [`magcal.c`](https://github.com/PaulStoffregen/MotionCal/blob/master/magcal.c)
...
Freescale Semiconductor, Inc. (2014). Their original notice is preserved
verbatim in [`LICENSE-UPSTREAM`](LICENSE-UPSTREAM).